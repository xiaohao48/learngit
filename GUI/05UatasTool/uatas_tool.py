...
aes_key_iv = {
    ...
    "front_end_zeus": {"key": "THi8cml8EPlcdkfh", "iv": "1Q2ik8vpod90lhTg"},  # zeus前端
    "back_end_zeus": {"key": "k169flxzbooneepf", "iv": "abc123rty456nji7"},  # zeus后台
...
scripts = {
    ...
    'uatas还款拉取': "php /home/rong/www/time-pay/webroot/batch.php TimePayRepay PollingRepayResult --orderNo='833487713322312' --payHandel='UP'",
    "uatas入贷后": "php /home/rong/www/time-cuishou/webroot/batch.php Daihouivr GetDaihouIvr --day=1",
    ...
    "用户storage目录查询": 'php -r "echo crc32(7044) % 10;"',
...
def control_request():
    """订单请求风控"""
    sql = f'UPDATE cash_order.orders as o SET o.create_time=o.create_time-3600 WHERE o.order_no={order_no.get()};'
